...
output "config_configuration_recorder" {
  ...
  value = {
    ...
    "me-south-1"     = one(module.config_baseline_me-south-1[*].configuration_recorder)
...
output "config_sns_topic" {
  ...
  value = {
    ...
    "me-south-1"     = one(module.config_baseline_me-south-1[*].config_sns_topic)
...
output "guardduty_detector" {
  ...
  value = {
    ...
    "me-south-1"     = one(module.guardduty_baseline_me-south-1[*].guardduty_detector)
...
output "vpc_flow_logs_group" {
  ...
  value = local.flow_logs_to_cw_logs ? {
    ...
    "me-south-1"     = one(module.vpc_baseline_me-south-1[*].vpc_flow_logs_group)
...
output "default_vpc" {
  ...
  value = {
    ...
    "me-south-1"     = one(module.vpc_baseline_me-south-1[*].default_vpc)
...
output "default_security_group" {
  ...
  value = {
    ...
    "me-south-1"     = one(module.vpc_baseline_me-south-1[*].default_security_group)
...
output "default_network_acl" {
  ...
  value = {
    ...
    "me-south-1"     = one(module.vpc_baseline_me-south-1[*].default_network_acl)
...
output "default_route_table" {
  ...
  value = {
    ...
    "me-south-1"     = one(module.vpc_baseline_me-south-1[*].default_route_table)
