...
[![Github Actions](https://github.com/wotbatt/terraform-aws-secure-baseline-v2/actions/workflows/main.yml/badge.svg)](https://github.com/wotbatt/terraform-aws-secure-baseline-v2/actions/workflows/main.yml)
[![Releases](https://img.shields.io/github/v/release/wotbatt/terraform-aws-secure-baseline-v2)](https://github.com/wotbatt/terraform-aws-secure-baseline-v2/releases/latest)

[Terraform Module Registry](https://registry.terraform.io/modules/wotbatt/secure-baseline-v2/aws)
...
| <a name="input_config_enable_override"></a> [config\_enable\_override](#input\_config\_enable\_override) | Boolean to indicate whether to create override settings for specific resource types. | `bool` | no |
...
| <a name="input_config_override_description"></a> [config\_override\_description](#input\_config\_override\_description) | Description for the override setting. | `string` | no |
| <a name="input_config_override_recording_frequency"></a> [config\_override\_recording\_frequency](#input\_config\_override\_recording\_frequency) | Frequency setting for the values described. | `string` | no |
| <a name="input_config_override_resource_types"></a> [config\_override\_resource\_types](#input\_config\_override\_resource\_types) | List of resource types for the override value. | `list(string)` | no |
| <a name="input_config_recording_frequency"></a> [config\_recording\_frequency](#input\_config\_recording\_frequency) | Specifies the frequency for recording config changes. | `string` | no |
